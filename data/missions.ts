...
// Positions alignées sur le SVG StoreScene.tsx (viewBox 400x320)
// x,y,width,height en % du viewBox
export const SCENE_ELEMENTS: SceneElement[] = [
  {
    id: 'scene-1',
    x: 32, y: 2, width: 36, height: 11,
    label: 'Panneau "PEINTURE" au-dessus du rayon',
    isError: false,
  },
  {
    id: 'scene-2',
    x: 74, y: 45, width: 14, height: 10,
  ...
  {
    id: 'scene-3',
    x: 46, y: 46, width: 8, height: 20,
    label: 'Kakemono masquant la fiche conseil',
    isError: true,
  ...
  {
    id: 'scene-4',
    x: 46, y: 32, width: 15, height: 10,
    label: 'Stop-rayon promo bien positionné',
    isError: false,
  },
  {
    id: 'scene-5',
    x: 3, y: 13, width: 43, height: 4,
  ...
  {
    id: 'scene-7',
    x: 46, y: 85, width: 12, height: 14,
    label: 'Marquage au sol orientant vers la caisse',
    isError: false,
  },
  {
    id: 'scene-8',
    x: 27, y: 31, width: 19, height: 11,
